...
const ChangePassword = () => {
  ...
  return (
    <section className="w-full flex justify-center items-center py-12">
      <article className="bg-black w-[40%] rounded-lg">
        ...
        <form onSubmit={handleSubmit} className="p-6 text-white">
          <div className="flex flex-col mb-3 relative">
            ...
            <input
              ...
              id="password"
              className="outline-none border border-blue-500 p-2 rounded-md bg-[#0C0C50]"
              name="password"
              value={password}
          ...
          <div className="flex flex-col mb-3">
            <button className="bg-[#0C0C80] font-semibold text-lg hover:bg-blue-700 py-2 mt-2 rounded-lg cursor-pointer">
